...
const RESOURCES: Resources = {
  zh: {
    ...
    upload: {
      ...
      removeImage: '移除图片',
      maxLimit: '最多可上传 3 张图片',
      remaining: '还可选择 {count} 张',
      addMore: '添加图片',
      setActive: '设为当前',
      active: '当前',
      singleMode: '单图模式',
      multipleMode: '多图模式',
      switchToMultiple: '多选图片',
      switchToSingle: '单张图片',
      slotLabel: '图 {index}',
    },
    mask: {
  ...
  en: {
    ...
    upload: {
      ...
      maxLimit: 'You can upload up to 3 images',
      remaining: '{count} more can be selected',
      addMore: 'Add images',
      setActive: 'Set as active',
      active: 'Active',
      singleMode: 'Single mode',
      multipleMode: 'Multi-image mode',
      switchToMultiple: 'Multiple images',
      switchToSingle: 'Single image',
      slotLabel: 'Image {index}',
    },
    mask: {
